...
class Group extends Model
{
    ...
    public static function getListGroupInfo($id_institute, $id_faculty, $id_department, $namegroup)
    {
        ...
        // ->join('dbwebsite_university.flow_group', 'flow_group.id_group','=','dbwebsite_university.group.id')
        ...
        // ->when($id_flow, function ($query, $id_flow)
        // {
        //     $query->where('dbwebsite_university.flow_group.id_flow', $id_flow);
        // })
